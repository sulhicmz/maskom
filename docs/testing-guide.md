...
## Overview
 ...
 The Maskom project uses **Jest** and **React Testing Library** for testing with over **2724 tests** across **109 test suites**. Test coverage includes components, hooks, utilities, services, and data validation.
