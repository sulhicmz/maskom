...
const faq_data: FaqItem[] = [
...

   {
      id: 1,
      page: "home_2",
      question: "Apa saja komponen layanan managed service Maskom?",
   ...
   },
   {
      id: 2,
      page: "home_2",
      question: "Bagaimana Maskom menjamin keamanan jaringan pelanggan?",
   ...
   },
   {
      id: 3,
      page: "home_2",
      question: "Bisakah Maskom membantu integrasi ke sistem monitoring internal?",
   ...
   },
   {
      id: 4,
      page: "home_2",
      question: "Apakah ada opsi layanan profesional proyek satu kali?",
   ...
   // home_3
   {
      id: 1,
      page: "home_3",
      question: "Siapa yang menjadi kontak utama selama implementasi?",
   ...
   },
   {
      id: 2,
      page: "home_3",
      question: "Berapa lama waktu penyediaan layanan setelah kontrak ditandatangani?",
   ...
   },
   {
      id: 3,
      page: "home_3",
      question: "Apakah Maskom menyediakan dokumentasi teknis lengkap?",
   ...
   },
   {
      id: 4,
      page: "home_3",
      question: "Bagaimana proses terminasi atau migrasi layanan?",
