      ...
      <section className="about-section pt-120 pb-65">
         <div className="container">
            <div className="row">
                    ...
                    <div className="about-image-box mb-25" role="img" aria-label="Galeri foto tim dan infrastruktur Maskom">
                       <div className="row">
                          <div className="col-lg-12">
                             <AnimationWrapper animation="fadeInDown" className="mb-25">
                                <Image src={about_img1} alt="Tim engineer Maskom bekerja di data center modern dengan peralatan jaringan canggih" priority />
                             </AnimationWrapper>
                          </div>
                         <div className="col-lg-6">
                            <AnimationWrapper animation="fadeInUp" className="mb-25">
                               <Image src={about_img2} alt="Tim dukungan teknis Maskom melayani pelanggan dengan profesional" loading="lazy" />
                            </AnimationWrapper>
                         </div>
                         <div className="col-lg-6">
                            <AnimationWrapper animation="fadeInUp" className="mb-25">
                               <Image src={about_img3} alt="Infrastruktur fiber optik Maskom untuk konektivitas internet berkecepatan tinggi" loading="lazy" />
                            </AnimationWrapper>
                         </div>
                      </div>
                   </div>
                     ...
                     <p>Didukung tim engineer berpengalaman, Maskom menyediakan layanan konsultasi, implementasi, hingga pengelolaan harian melalui Network Operation Center. Pendekatan kami selalu kolaboratif agar solusi yang dihadirkan selaras dengan strategi teknologi informasi setiap organisasi.</p>
                       <div className="author-card d-flex align-items-center justify-content-between">
                          <div className="author-thumb-item d-flex align-items-center">
                             <div className="thumb">
                                <Image src={author} alt="Foto profil tim Maskom Network" loading="lazy" />
                             </div>
                          ...
                          <div className="author-sign">
                             <Image src={signature} alt="Tanda tangan resmi Tim Maskom Network" loading="lazy" />
                          </div>
                       </div>
                  </AnimationWrapper>
               </div>
