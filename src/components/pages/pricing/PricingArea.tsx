      ...
      <section className="pricing-section pt-110">
         <div className="container">
               ...
               <div className="col-lg-12">
                  <div className="section-title text-center mb-50 wow fadeInDown">
                     ...
                     <p>In a few seconds, our A.I. will generate amazing results that <br /> you can copy,
                        paste & publish. , write creatively in </p>
                  </div>
               </div>
            </div>
            <div className="row">
            ...
            <div className="tab-content wow fadeInDown">
               {price_data.filter((prices) => prices.page === "inner_page").map((items, index) => (
                  <div key={items.id} className={`tab-pane fade ${activeTab === index ? 'show active' : ''}`} id="monthly">
                     <div className="row">
