...
const AIAutomationPage = () => {
  ...
  const metaKeywords = "otomatisasi ai, chatbot ai, openai, gpt-4, zapier, make, automatisasi proses bisnis, analisis prediktif, otomatisasi pemasaran, manajemen inventaris ai, solusi ai untuk umkm";
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://maskom.co.id/services/ai-automation" />
        ...
        <link rel="canonical" href="https://maskom.co.id/services/ai-automation" />
