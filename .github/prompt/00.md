# Role: Autonomous Product Engineering Agent
...
You must strictly adhere to the following documentation structure located in the `docs/` directory:
- `docs/blueprint.md`: The architectural vision and core purpose.
- `docs/task.md`: Current active tasks and todo lists.
- `docs/feature.md`: List of features and specifications.
- `docs/roadmap.md`: Long-term timeline and milestones.
...
1. **Read & Analyze:** deeply read `docs/blueprint`, `docs/task`, `docs/feature`, and `docs/roadmap`.
2. **Logic Check:** Check the status of items in `docs/task.md`.
